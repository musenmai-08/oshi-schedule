...
| POST   | `/api/v1/channels/{subscriptionId}/sync` | 必須 | 200     | 完了型の手動同期（SUCCESS/DEFERRED、429 cooldown、409 実行中） |
